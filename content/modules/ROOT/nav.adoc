* xref:01-getting-started.adoc[1. はじめに]
** xref:01-getting-started.adoc#cluster-login[OpenShift クラスターへのログイン]
** xref:01-getting-started.adoc#open-web-terminal[ワークショップWebターミナル]

* xref:02-gitops-basics.adoc[2. GitOps基礎]
** xref:02-gitops-basics.adoc#review-argocd[Argo CD デプロイメントの確認]
** xref:02-gitops-basics.adoc#connect-argocd[Argo CDへの接続]
** xref:02-gitops-basics.adoc#deploy-sample-application[サンプルアプリケーションのデプロイ]
